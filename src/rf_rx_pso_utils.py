...
############## still used in rf_rx_pso_per_case.py ##############
# match the format as pso_per_case_with_nan_control
####### REVISED 0829 - penalty included / current_z01, current_penalty output added #######
...
# def pso_all_with_nan_control(objective_fn, n_particles, n_iterations, 
#                                 case1_alpha_bounds, case2_alpha_bounds, case3_alpha_bounds,
#                                 case1_alpha_names, case2_alpha_names, case3_alpha_names,
#                                 case1_param_bounds, case2_param_bounds, case3_param_bounds,
#                                 case1_param_names, case2_param_names, case3_param_names,
#                                 neg_z_fom, nan_z_fom,
#                                 crash_sentinel=None, # crashed not because of Neg Z or NaN
#                                 max_retry_per_particle=5, 
...
#     alphas_case1_lb, alphas_case1_ub = np.array(case1_alpha_bounds[0]), np.array(case1_alpha_bounds[1])
#     alphas_case2_lb, alphas_case2_ub = np.array(case2_alpha_bounds[0]), np.array(case2_alpha_bounds[1])
#     alphas_case3_lb, alphas_case3_ub = np.array(case3_alpha_bounds[0]), np.array(case3_alpha_bounds[1])

#     omegas_case1_lb, omegas_case1_ub = np.array(case1_param_bounds[0]), np.array(case1_param_bounds[1])
#     omegas_case2_lb, omegas_case2_ub = np.array(case2_param_bounds[0]), np.array(case2_param_bounds[1])
#     omegas_case3_lb, omegas_case3_ub = np.array(case3_param_bounds[0]), np.array(case3_param_bounds[1])

#     alphas_case1_dim = len(alphas_case1_lb)
#     alphas_case2_dim = len(alphas_case2_lb)
#     alphas_case3_dim = len(alphas_case3_lb)

#     omegas_case1_dim = len(omegas_case1_lb)
#     omegas_case2_dim = len(omegas_case2_lb)
#     omegas_case3_dim = len(omegas_case3_lb)

#     options = {'c1': 1.5, 'c2': 1.5, 'w': 0.7}


#     # initialize new swarm
#     alphas_case1_init_pos = np.stack([custom_initializer("case1") for _ in range(n_particles)])
#     alphas_case2_init_pos = np.stack([custom_initializer("case2") for _ in range(n_particles)])
#     alphas_case3_init_pos = np.stack([custom_initializer("case3") for _ in range(n_particles)])

#     omegas_case1_init_pos = np.random.uniform(low=omegas_case1_lb, high=omegas_case1_ub, size=(n_particles, omegas_case1_dim))
#     omegas_case2_init_pos = np.random.uniform(low=omegas_case2_lb, high=omegas_case2_ub, size=(n_particles, omegas_case2_dim))
#     omegas_case3_init_pos = np.random.uniform(low=omegas_case3_lb, high=omegas_case3_ub, size=(n_particles, omegas_case3_dim))

#     case1_init_pos = np.hstack([alphas_case1_init_pos, omegas_case1_init_pos])
#     case2_init_pos = np.hstack([alphas_case2_init_pos, omegas_case2_init_pos])
#     case3_init_pos = np.hstack([alphas_case3_init_pos, omegas_case3_init_pos])
...
#                 case1_alphas_particle = case1_particle[:alphas_case1_dim]
#                 case2_alphas_particle = case2_particle[:alphas_case2_dim]
#                 case3_alphas_particle = case3_particle[:alphas_case3_dim]

#                 case1_omegas_particle = case1_particle[alphas_case1_dim:]
#                 case2_omegas_particle = case2_particle[alphas_case2_dim:]
#                 case3_omegas_particle = case3_particle[alphas_case3_dim:]

#                 case1_alphas_dict = dict(zip(case1_alpha_names, case1_alphas_particle)) if case1_alpha_names else {}
#                 case2_alphas_dict = dict(zip(case2_alpha_names, case2_alphas_particle)) if case2_alpha_names else {}
#                 case3_alphas_dict = dict(zip(case3_alpha_names, case3_alphas_particle)) if case3_alpha_names else {}

#                 case1_omegas_dict = dict(zip(case1_param_names, case1_omegas_particle)) if case1_param_names else {}
#                 case2_omegas_dict = dict(zip(case2_param_names, case2_omegas_particle)) if case2_param_names else {}
#                 case3_omegas_dict = dict(zip(case3_param_names, case3_omegas_particle)) if case3_param_names else {}

#                 case1_particle_dict = {**case1_alphas_dict, **case1_omegas_dict}
#                 case2_particle_dict = {**case2_alphas_dict, **case2_omegas_dict}
#                 case3_particle_dict = {**case3_alphas_dict, **case3_omegas_dict}

#                 alphas_dict = {**case1_alphas_dict, **case2_alphas_dict, **case3_alphas_dict}
#                 omegas_dict = {**case1_omegas_dict, **case2_omegas_dict, **case3_omegas_dict}
#                 particle_dict = {**alphas_dict, **omegas_dict}
...
#                 else:
#                     case1_fom, case2_fom, case3_fom, case1_weighted_z01_loss, case2_weighted_z01_loss, case3_weighted_z01_loss = result
#                     case_foms = [case1_fom, case2_fom, case3_fom]
#                     case_losses = [case1_weighted_z01_loss, case2_weighted_z01_loss, case3_weighted_z01_loss]
#                     case_dicts = [case1_particle_dict, case2_particle_dict, case3_particle_dict]
#                     case_dicts_dims = [alphas_case1_dim + omegas_case1_dim, alphas_case2_dim + omegas_case2_dim, alphas_case3_dim + omegas_case3_dim]
#                     retry_succeeded_dicts = []
...
#                 if retry_needed:
#                     if iter_idx == 0: # if first iteration, randomly generate new point for simulation
#                         # JUST FOR OMEGAS (I assume alphas are not responsible for NaN)

#                         omegas_case1_new_pos = np.random.uniform(low=omegas_case1_lb, high=omegas_case1_ub, size=(omegas_case1_dim,))
#                         omegas_case2_new_pos = np.random.uniform(low=omegas_case2_lb, high=omegas_case2_ub, size=(omegas_case2_dim,))
#                         omegas_case3_new_pos = np.random.uniform(low=omegas_case3_lb, high=omegas_case3_ub, size=(omegas_case3_dim,))

#                         case1_new_pos = np.hstack([case1_alphas_particle, omegas_case1_new_pos])
#                         case2_new_pos = np.hstack([case2_alphas_particle, omegas_case2_new_pos])
#                         case3_new_pos = np.hstack([case3_alphas_particle, omegas_case3_new_pos])

#                     else:
#                         scale_factor = 0.5 ** retry_count
#                         case1_new_pos = original_case1_particle + scale_factor * original_case1_velocity
#                         alphas_case1_new_pos = np.clip(case1_new_pos[:alphas_case1_dim], alphas_case1_lb, alphas_case1_ub)
#                         omegas_case1_new_pos = np.clip(case1_new_pos[alphas_case1_dim:], omegas_case1_lb, omegas_case1_ub)

#                         case2_new_pos = original_case2_particle + scale_factor * original_case2_velocity
#                         alphas_case2_new_pos = np.clip(case2_new_pos[:alphas_case2_dim], alphas_case2_lb, alphas_case2_ub)
#                         omegas_case2_new_pos = np.clip(case2_new_pos[alphas_case2_dim:], omegas_case2_lb, omegas_case2_ub)

#                         case3_new_pos = original_case3_particle + scale_factor * original_case3_velocity
#                         alphas_case3_new_pos = np.clip(case3_new_pos[:alphas_case3_dim], alphas_case3_lb, alphas_case3_ub)
#                         omegas_case3_new_pos = np.clip(case3_new_pos[alphas_case3_dim:], omegas_case3_lb, omegas_case3_ub)

#                         case1_new_pos = np.hstack([alphas_case1_new_pos, omegas_case1_new_pos])
#                         case2_new_pos = np.hstack([alphas_case2_new_pos, omegas_case2_new_pos])
#                         case3_new_pos = np.hstack([alphas_case3_new_pos, omegas_case3_new_pos])

#                     case1_swarm.position[idx] = case1_new_pos
#                     case2_swarm.position[idx] = case2_new_pos
#                     case3_swarm.position[idx] = case3_new_pos
...
#                         case_foms[i] = retry_foms[i]
#                         case_losses[i] = retry_losses[i]
#                         final_retry_succeeded_dicts.append(valid_particle_dict)
#                 case1_fom, case2_fom, case3_fom = case_foms
#                 case1_weighted_z01_loss, case2_weighted_z01_loss, case3_weighted_z01_loss = case_losses
...
#                 print(f"[FAIL][CASE1] Particle {idx} failed after {max_retry_per_particle} retries.")
#                 case1_cost[idx] = - nan_z_fom
#                 case1_z01_losses.append(None)
#             else:
#                 case1_cost[idx] = - (case1_fom - case1_weighted_z01_loss)
#                 case1_z01_losses.append(case1_weighted_z01_loss)

#             if case2_fom is None or case2_weighted_z01_loss is None:
#                 print(f"[FAIL][CASE2] Particle {idx} failed after {max_retry_per_particle} retries.")
#                 case2_cost[idx] = - nan_z_fom
#                 case2_z01_losses.append(None)
#             else:
#                 case2_cost[idx] = - (case2_fom - case2_weighted_z01_loss)
#                 case2_z01_losses.append(case2_weighted_z01_loss)

#             if case3_fom is None or case3_weighted_z01_loss is None:
#                 print(f"[FAIL][CASE3] Particle {idx} failed after {max_retry_per_particle} retries.")
#                 case3_cost[idx] = - nan_z_fom
#                 case3_z01_losses.append(None)
#             else:
#                 case3_cost[idx] = - (case3_fom - case3_weighted_z01_loss)
#                 case3_z01_losses.append(case3_weighted_z01_loss)

#             if verbose:
#                 print(f"Case1 Particle {idx} cost: {case1_cost[idx]}, fom:{case1_fom}, z01_loss: {case1_z01_losses[-1]}")
#                 print(f"Case2 Particle {idx} cost: {case2_cost[idx]}, fom:{case2_fom}, z01_loss: {case2_z01_losses[-1]}")
#                 print(f"Case3 Particle {idx} cost: {case3_cost[idx]}, fom:{case3_fom}, z01_loss: {case3_z01_losses[-1]}")
...
#         case2_cost_history.append(case2_gbest_cost)
#         case3_cost_history.append(case3_gbest_cost)
#         case1_z01_loss_history.append(case1_z01_losses)
#         case2_z01_loss_history.append(case2_z01_losses)
#         case3_z01_loss_history.append(case3_z01_losses)

#         alphas_case1_current_best = dict(zip(case1_alpha_names, case1_gbest_pos[:alphas_case1_dim]))
#         omegas_case1_current_best = dict(zip(case1_param_names, case1_gbest_pos[alphas_case1_dim:]))
#         alphas_case2_current_best = dict(zip(case2_alpha_names, case2_gbest_pos[:alphas_case2_dim]))
#         omegas_case2_current_best = dict(zip(case2_param_names, case2_gbest_pos[alphas_case2_dim:]))
#         alphas_case3_current_best = dict(zip(case3_alpha_names, case3_gbest_pos[:alphas_case3_dim]))
#         omegas_case3_current_best = dict(zip(case3_param_names, case3_gbest_pos[alphas_case3_dim:]))
        
#         alphas_history.append({
#             'outer_iter': iter_idx+1,
#             'case1_alphas': alphas_case1_current_best,
#             'case1_cost': case1_gbest_cost,
#             'case2_alphas': alphas_case2_current_best,
#             'case2_cost': case2_gbest_cost,
#             'case3_alphas': alphas_case3_current_best,
#             'case3_cost': case3_gbest_cost
#         })

#         omegas_history.append({
#             'outer_iter': iter_idx+1,
#             'case1_omegas': omegas_case1_current_best,
#             'case1_cost': case1_gbest_cost,
#             'case2_omegas': omegas_case2_current_best,
#             'case2_cost': case2_gbest_cost,
#             'case3_omegas': omegas_case3_current_best,
#             'case3_cost': case3_gbest_cost
#         })

#         bh=BoundaryHandler(strategy="nearest")

#         case1_lower_bounds = np.hstack([alphas_case1_lb, omegas_case1_lb])
#         case1_upper_bounds = np.hstack([alphas_case1_ub, omegas_case1_ub])
#         case2_lower_bounds = np.hstack([alphas_case2_lb, omegas_case2_lb])
#         case2_upper_bounds = np.hstack([alphas_case2_ub, omegas_case2_ub])
#         case3_lower_bounds = np.hstack([alphas_case3_lb, omegas_case3_lb])
#         case3_upper_bounds = np.hstack([alphas_case3_ub, omegas_case3_ub])
...
#     return gbest_cost, gbest_pos, cost_history, z01_loss_history, gbest_iteration_record, alphas_history, omegas_history
